...
public class CompileArduinoProjectAction implements IObjectActionDelegate, SelectedFilePathAndContextFinder {
	...
	public void run(IAction action) {
		...
		try {
			...
			boolean compilationOK = CompilationStepInstance.performCompilation(foundFqbn, foundPortAddress, target, true, parentLocation);
			if(!compilationOK){
			...
			MessageDialog.openInformation(
					...
					"The folder with the result files has been generated\n"+
