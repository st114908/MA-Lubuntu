...
*/
#define CI_DRIVECONTROLLERSDRIVECONTROLLER 1 /**< Identifier for Component Instance driveController.S */
#define CI_COURSECONTROLSCOURSECONTROL 2 /**< Identifier for Component Instance courseControl.S */
