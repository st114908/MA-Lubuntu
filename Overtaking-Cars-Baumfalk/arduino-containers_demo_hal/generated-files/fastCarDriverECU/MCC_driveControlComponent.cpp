...
DriveControlComponent* MCC_create_DriveControlComponent(uint8_T ID){
	...
	switch(ID){
		case CI_DRIVECONTROLFDRIVECONTROL:
			...
			b.VELOCITY_op.local_option.pubID = -20136;
			b.VELOCITY_op.local_option.subID = -24519;
			...
			b.REARDISTANCE_op.local_option.pubID = -8241;
			b.REARDISTANCE_op.local_option.subID = -31949;
			b.FRONTDISTANCE = PORT_ACTIVE;
			b.createFRONTDISTANCEHandle = &create_FRONTDISTANCELocalHandle;
			b.FRONTDISTANCE_op.local_option.pubID = -28908;
			b.FRONTDISTANCE_op.local_option.subID = -12577;
		break;
	default:
		break;
	}
