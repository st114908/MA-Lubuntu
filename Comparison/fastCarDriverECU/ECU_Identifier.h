...
*/
#define CI_COURSECONTROLFCOURSECONTROL 1 /**< Identifier for Component Instance courseControl.F */
#define CI_DRIVECONTROLLERFDRIVECONTROLLER 2 /**< Identifier for Component Instance driveController.F */
