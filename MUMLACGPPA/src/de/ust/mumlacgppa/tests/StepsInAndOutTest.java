...
public class StepsInAndOutTest implements Keywords {
	...
	/*
	 * // This won't work anymore since the Steps have been changed to working
	 * with a given VariableHandler.
	 * 
	 * @Test public void testYamlConstructor() throws
	 * VariableNotDefinedException, StructureException, FaultyDataException,
	 * ParameterMismatchException { String testYamlTextCompleteDefinitionContent
	 * = inFlag + ":\n" + "  input1: from testTrueVariable\n" +
	 * "  input2: from testFalseVariable\n" + outFlag + ":\n" +
	 * "  output1: testNumberVariable\n" + "  output2: testTextVariable\n";
	 * 
	 * Constructor constructor = new Constructor(InternalTestDummyStep.class,
	 * new LoaderOptions());//InternalTestDummyStep.class is root
	 * TypeDescription carDescription = new
	 * TypeDescription(InternalTestDummyStep.class);
	 * constructor.addTypeDescription(carDescription); Yaml yaml2 = new
	 * Yaml(constructor); InternalTestDummyStep testInstance =
	 * yaml2.load(testYamlTextCompleteDefinitionContent);
